...
// Clase auxiliar con métodos estáticos para calcular y verificar hashes SHA-256.
// SHA-256 NO es un cifrado: es una función de hash unidireccional (no se puede "descifrar").
...
public class HashSHA256 {
    ...
    // Calcula el SHA-256 de un texto y devuelve el digest en Base64
