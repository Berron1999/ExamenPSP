    ...
    public void run() {
        try (
            ...
            for (int i = 1; i <= numMensajes; i++) {
                ...
                // Enviamos "mensaje|hash"
                salida.println(HashSHA256.empaquetar(msgClaro));

                // Recibimos "eco|hash" y verificamos integridad
                ...
                boolean integro = HashSHA256.verificar(eco, hashRecibido);
