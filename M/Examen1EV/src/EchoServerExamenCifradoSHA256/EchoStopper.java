...
// Envía la señal de parada "." con su hash SHA-256 y muestra los datos de uso
public class EchoStopper {
    ...
    public static void main(String[] args) {
        try (
            ...
            System.out.println("[EchoStopper] Enviando señal de parada con hash SHA-256...");
            ...
            int sep = respuesta.lastIndexOf(HashSHA256.SEP);
            ...
            System.out.println("[EchoStopper] Integridad: " + HashSHA256.verificar(datosUso, hashRecibido));
