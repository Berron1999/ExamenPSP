...
public class UtilCifrado {
    ...
    // clave AES de 16 bytes (128 bits) compartida entre cliente y servidor
    // en un caso real NUNCA iria asi en el codigo, pero para el ejercicio nos vale
    private static final byte[] CLAVE = {
            0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,
            0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16
    };

    // pequeña clase auxiliar para devolver datos cifrados + iv juntos
    ...
    public static ResultadoCifrado cifrar(String texto) throws Exception {
        byte[] iv = new byte[16];
        new SecureRandom().nextBytes(iv); // iv aleatorio, distinto en cada cifrado
